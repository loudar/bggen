...
import {random, randomColor, randomFloat, randomOf, randomString} from "./Random";
import {AnyElement, AnyNode, create, isSignal, signal} from "@targoninc/jess";
...
export class Generator {
    ...
    constructor(canvas: HTMLCanvasElement) {
        ...
        this.settings = {
            "hue.min": {value: 0, icon: "colorize", group: "color"},
            "hue.max": {value: 360, icon: "colorize", group: "color"},
            "saturation.min": {value: 0, icon: "invert_colors", group: "color"},
            "saturation.max": {value: 100, icon: "invert_colors", group: "color"},
            "lightness.min": {value: 0, icon: "wb_sunny", group: "color"},
            "lightness.max": {value: 100, icon: "wb_sunny", group: "color"},
            "transparency.min": {value: 0, icon: "opacity", group: "color"},
            "transparency.max": {value: 100, icon: "opacity", group: "color"},
            "hueVariation.min": {value: 0, icon: "colorize", group: "variation"},
            "hueVariation.max": {value: 100, icon: "colorize", group: "variation"},
            "saturationVariation.min": {value: 0, icon: "invert_colors", group: "variation"},
            "saturationVariation.max": {value: 100, icon: "invert_colors", group: "variation"},
            "lightnessVariation.min": {value: 0, icon: "wb_sunny", group: "variation"},
            "lightnessVariation.max": {value: 100, icon: "wb_sunny", group: "variation"},
            "transparencyVariation.min": {value: 0, icon: "opacity", group: "variation"},
            "transparencyVariation.max": {value: 100, icon: "opacity", group: "variation"},
            "rectangleCount.min": {value: 1, icon: "crop_square", group: "shapes", subgroup: "rectangles"},
            "rectangleCount.max": {value: 50, icon: "crop_square", group: "shapes", subgroup: "rectangles"},
            "rectangleWidth.min": {value: 1, icon: "crop_square", group: "shapes", subgroup: "rectangles"},
            "rectangleWidth.max": {value: 25, icon: "crop_square", group: "shapes", subgroup: "rectangles"},
            "rectangleHeight.min": {value: 1, icon: "crop_square", group: "shapes", subgroup: "rectangles"},
            "rectangleHeight.max": {value: 25, icon: "crop_square", group: "shapes", subgroup: "rectangles"},
            "rectangleWeight.min": {value: 1, icon: "crop_square", group: "shapes", subgroup: "rectangles"},
            "rectangleWeight.max": {value: 10, icon: "crop_square", group: "shapes", subgroup: "rectangles"},
            "rectangleTypes": {
            ...
            "circleCount.min": {value: 0, icon: "panorama_fish_eye", group: "shapes", subgroup: "circles"},
            "circleCount.max": {value: 10, icon: "panorama_fish_eye", group: "shapes", subgroup: "circles"},
            "circleRadius.min": {value: 1, icon: "panorama_fish_eye", group: "shapes", subgroup: "circles"},
            "circleRadius.max": {value: 25, icon: "panorama_fish_eye", group: "shapes", subgroup: "circles"},
            "circleWeight.min": {value: 1, icon: "panorama_fish_eye", group: "shapes", subgroup: "circles"},
            "circleWeight.max": {value: 10, icon: "panorama_fish_eye", group: "shapes", subgroup: "circles"},
            "circleTypes": {
                value: {fill: true, stroke: true, gradient: true},
            ...
            "textSize.max": {value: 10, icon: "text_fields", group: "shapes", subgroup: "texts"},
            "textWeight.min": {value: 1, icon: "text_fields", group: "shapes", subgroup: "texts"},
            "textWeight.max": {value: 10, icon: "text_fields", group: "shapes", subgroup: "texts"},
            "textTypes": {
                value: {fill: true, stroke: true, gradient: true},
                icon: "text_fields",
                group: "shapes",
            ...
            "waveCount.min": {value: 0, icon: "waves", group: "shapes", subgroup: "waves"},
            "waveCount.max": {value: 5, icon: "waves", group: "shapes", subgroup: "waves"},
            "waveSize.min": {value: 1, icon: "waves", group: "shapes", subgroup: "waves"},
            "waveSize.max": {value: 10, icon: "waves", group: "shapes", subgroup: "waves"},
            "waveThickness.min": {value: 1, icon: "waves", group: "shapes", subgroup: "waves"},
            "waveThickness.max": {value: 50, icon: "waves", group: "shapes", subgroup: "waves"},
            "waveTypes": {
                value: {fill: true, stroke: true, gradient: true},
                icon: "waves",
                group: "shapes",
            ...
            "gridCount.min": {value: 1, icon: "grid_on", group: "grid"},
            "gridCount.max": {value: 10, icon: "grid_on", group: "grid"},
            "gridSize.min": {value: 2, icon: "grid_on", group: "grid"},
            "gridSize.max": {value: 10, icon: "grid_on", group: "grid"},
            "keepCurrentItems": {value: signal(false), icon: "save", group: "other"},
            "keepCurrentColors": {value: signal(false), icon: "colorize", group: "other"},
            "applyRandomFilter": {value: signal(false), icon: "filter_list", group: "other"},
            "keepCurrentFilter": {value: signal(false), icon: "filter_list", group: "other"},
            "textFont": {value: "sans-serif", icon: "font_download", group: "other"}
        } as any;
        this.colors = {
            h: signal(0),
            s: signal(0),
    ...
    getControls() {
        const groups = Object.values(this.settings).reduce((acc: any, setting: any) => {
            if (setting.group) {
        ...
        elements.push(create("div").classes("flex").children(...colorGroup).build());
        for (const group in groups) {
            const hasSubgroups = groups[group].some((setting: any) => setting.subgroup);
            if (hasSubgroups) {
                const subgroups = groups[group].reduce((acc: any, setting: any) => {
                    if (setting.subgroup) {
                        if (!acc[setting.subgroup]) acc[setting.subgroup] = [];
                        acc[setting.subgroup].push(setting);
                    }
                    return acc;
                }, {} as any);
                const content = Object.keys(subgroups).map(subgroup => {
                    const subgroupContent = subgroups[subgroup].map((setting: any) => {
                        const settingKey = Object.keys(this.settings).find((key: any) => (this.settings as any)[key] === setting) as string;
            ...
            const content = groups[group].map((setting: any) => {
                const settingKey = Object.keys(this.settings).find((key: any) => (this.settings as any)[key] === setting) as string;
                return this.getSettingControl(settingKey);
            });
            elements.push(Templates.collapsible(group, content));
    ...
    getSettingControl(path: string) {
        const v = this.getSettingValue(path);
        if ((v as any).constructor === Number) {
            return this.getSettingRangeControl(path);
        } else if ((v as any).constructor === Boolean) {
            return this.getSettingCheckboxControl(path);
        } else if ((v as any).constructor === String) {
            return this.getSettingTextControl(path);
        }
    }

    getSettingTextControl(path: string) {
        return Templates.textControl(path, this.getSettingValue(path), (newValue: string) => {
            this.setSettingValue(path, newValue);
        });
    }

    getSettingCheckboxControl(path: string) {
        return Templates.checkboxControl(path, (this.settings as any)[path].value, (this.settings as any)[path].icon, (checked: boolean) => {
            if (path !== "applyRandomFilter") return;
            if (checked) {
                this.renderer.applyFilter(this.currentFilter);
            } else {
                this.renderer.applyFilter("none");
            }
            (this.renderer.ctx as any).save?.();
        });
    }

    getSettingRangeControl(path: string) {
        return Templates.rangeControl(path, (this.settings as any)[path].value, (this.settings as any)[path].icon, (e: any) => {
    ...
    generateImage() {
        let h: number, s: number, l: number, t: number, hv: number, sv: number, lv: number, tv: number;
        ...
        let items: any[] = [], grids: any[] = [];
        if (this.getSettingValue("keepCurrentItems")) {
            // @ts-ignore
            items = (window as any).currentData.items;
            // @ts-ignore
            grids = (window as any).currentData.grids;
            ...
            for (let i = 0; i < gridCount; i++) {
                ...
                grids.push({shape: "grid", x, y, width, height, items: []});
            }
        ...
        this.renderer.getBitmap(0.1).then((imageData: any) => {
            this.addToHistory({h, s, l, t, hv, sv, lv, tv, items, filter, imageData, background});
        });
    }

    getBackground(h: number, s: number, l: number, t: number, hv: number, sv: number, lv: number, tv: number) {
        const type = randomOf(["fill", "gradient"]);
        return {type, colors: this.getColorsForType(type as any, h, s, l, t, hv, sv, lv, tv)};
    }

    addToHistory(data: any) {
        const oldHistory = this.history.value as any[];
    ...
    loadHistoryEntry(index?: number) {
        ...
        const history = this.history.value as any[];
        ...
        (window as any).currentData = {items: data.items, grids: data.grids};
    ...
    getRectangles(h: number, s: number, l: number, t: number, hv: number, sv: number, lv: number, tv: number, count: number, grids: any[]) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            if (isOnGrid) {
                const randomGridWithFreeSpace = grids.find(grid => grid.items.length < grid.width * grid.height);
            ...
            rectangles.push({shape: "rectangle", type, colors, x, y, width, height, weight});
        }
        return rectangles;
    }

    getCircles(h: number, s: number, l: number, t: number, hv: number, sv: number, lv: number, tv: number, circleCount: number, grids: any[]) {
        const circles: any[] = [];
        for (let i = 0; i < circleCount; i++) {
            ...
            if (isOnGrid) {
                ...
                if (randomGridWithFreeSpace) {
                    ...
                    grid.items.push({shape: "circle", type, colors, weight, x, y, radius: radius / 2, size: radius});
                }
            }
    ...
    getSettingValue(path: string) {
        if (isSignal((this.settings as any)[path].value)) {
            return (this.settings as any)[path].value.value;
        }
        return (this.settings as any)[path].value;
    }

    setSettingValue(path: string, value: any) {
        if (isSignal((this.settings as any)[path].value)) {
            (this.settings as any)[path].value.value = value;
        } else {
            (this.settings as any)[path].value = value;
        }
    }

    getColorsForType(type: string, h: number, s: number, l: number, t: number, hv: number, sv: number, lv: number, tv: number) {
        const colors: any[] = [];
    ...
    getTexts(h: number, s: number, l: number, t: number, hv: number, sv: number, lv: number, tv: number, textCount: number) {
        const texts: any[] = [];
        for (let i = 0; i < textCount; i++) {
            ...
            texts.push({shape: "text", type, colors, x, y, size, text, weight});
        }
        return texts;
    }

    getWaves(h: number, s: number, l: number, t: number, hv: number, sv: number, lv: number, tv: number, waveCount: number) {
        const waves: any[] = [];
        for (let i = 0; i < waveCount; i++) {
            ...
            waves.push({shape: "wave", type, colors, x, y, size, wave, weight});
        }
        return waves;
    }
    ...
    getCanvasFilter() {
        ...
        const filter = randomOf(avilableFilters as any);
